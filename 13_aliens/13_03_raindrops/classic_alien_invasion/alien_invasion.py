# Difficulty: 1/10 Just had to follow the book.
# Updated the code to move aliens from left to right, then when it hits the side will move down and then move right to left.
